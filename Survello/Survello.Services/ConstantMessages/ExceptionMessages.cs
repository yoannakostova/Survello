...
namespace Survello.Services.ConstantMessages
{
    public static class ExceptionMessages
    {
        ...
        public const string TitleNull = "Title can`t be empty.";

        public const string MailSenderError = "Something went wrong... Please try again!";
        public const string BlobError = "Something went wrong... Please try again!";
    }
}
